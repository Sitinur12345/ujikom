...
@section('title', 'Edit Halaman - Galeri Edu')
    ...
    <div class="bg-white shadow-lg rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-bold text-gray-800">Edit Halaman</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('meta_title', optional($page->meta_data)['meta_title']) }}"
                            >
                        </div>
                        ...
                        <div>
                            ...
                            >{{ old('meta_description', optional($page->meta_data)['meta_description']) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('meta_keywords', optional($page->meta_data)['meta_keywords']) }}"
                            >
                        </div>
                    </div>
                </div>
